namespace $ {
	export class $mol_view_tree2_ts_test_sample_bind_both extends $mol_view {
		...
		localized_owner(val?: any) {
			if ( val !== undefined ) return val
			return this.$.$mol_locale.text( '$mol_view_tree2_ts_test_sample_bind_both_localized_owner' )
		}
		...
		loc_outer(v?: any) {
			if ( v !== undefined ) return v
			return this.$.$mol_locale.text( '$mol_view_tree2_ts_test_sample_bind_both_loc_outer' )
		}
