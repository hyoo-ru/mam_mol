declare namespace $ {
	...
	type $mol_view_tree2_to_js_test_ex_right_read_only_bar_b__N2HKQI7H = $mol_type_enforce<
	...
	>
	type $mol_view_tree2_to_js_test_ex_right_read_only_bar_b__MA38RMYV = $mol_type_enforce<
