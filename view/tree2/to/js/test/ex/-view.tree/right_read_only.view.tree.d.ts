declare namespace $ {
	...
	type $mol_view_tree2_to_js_test_ex_right_read_only_bar_b__UNXI35DB = $mol_type_enforce<
	...
	>
	type $mol_view_tree2_to_js_test_ex_right_read_only_bar_b__3N4XMWIK = $mol_type_enforce<
