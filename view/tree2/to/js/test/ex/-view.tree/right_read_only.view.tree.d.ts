declare namespace $ {
	...
	type $mol_view_tree2_to_js_test_ex_right_read_only_bar_b__NBUIHK6G = $mol_type_enforce<
	...
	>
	type $mol_view_tree2_to_js_test_ex_right_read_only_bar_b__R6F43RSP = $mol_type_enforce<
