declare namespace $ {
	...
	type $mol_view_tree2_to_js_test_ex_right_read_only_bar_b__KK8UCFIN = $mol_type_enforce<
	...
	>
	type $mol_view_tree2_to_js_test_ex_right_read_only_bar_b__6MDMW4A8 = $mol_type_enforce<
