declare namespace $ {
	...
	type $mol_view_tree2_to_js_test_ex_right_read_only_bar_b__12GDYCKA = $mol_type_enforce<
	...
	>
	type $mol_view_tree2_to_js_test_ex_right_read_only_bar_b__3PBNWYKB = $mol_type_enforce<
