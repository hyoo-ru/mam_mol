namespace $ {
	 ...
	 * `undefined`); реальные значения приходят при вызове `$mol_gql`.
	 */
	 ...
	 * Если нужен другой транспорт (сокет, RPC, live-queries) — игнорируй,
	 * пиши свой helper над тем же объектом операции.
	 *
