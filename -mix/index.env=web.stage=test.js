...
(function ($) {
    var $mol_stacker = (function (_super) {
        ...
        $mol_stacker.prototype.mainer = function () {
            ...
            return new $mol_viewer().setup(function (_) {
                _.childs = function () {
                    ...
                    return [].concat(_this.main().valueOf());
                };
            });
        };
        ...
        $mol_stacker.prototype.addoner = function () {
            ...
            return new $mol_viewer().setup(function (_) {
                _.childs = function () {
                    ...
                    return [].concat(_this.addon().valueOf());
                };
            });
        };
        $mol_stacker.prototype.childs = function () {
            ...
            return [].concat(this.mainer().valueOf(), this.addoner().valueOf());
        };
        __decorate([
            $mol_prop()
...
(function ($) {
    var $mol_demo_all = (function (_super) {
        ...
        $mol_demo_all.prototype.addoner = function () {
            var _this = this;
            var diff = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                diff[_i - 0] = arguments[_i];
        ...
        __decorate([
            $mol_prop()
        ], $mol_demo_all.prototype, "addoner", null);
        __decorate([
            $mol_prop()
...
(function ($) {
    ...
    (function ($mol) {
        var $mol_demo_all = (function (_super) {
            ...
            $mol_demo_all.prototype.names = function () {
                var names = [];
                for (var name in $) {
            ...
            $mol_demo_all.prototype.items = function () {
                ...
                if (selected) {
                    ...
                    return this.names().map(function (name) { return _this.item(name); });
                }
            };
            ...
            __decorate([
                $mol_prop()
            ], $mol_demo_all.prototype, "names", null);
            __decorate([
                $mol_prop()
