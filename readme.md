...
Вместо обеспечения конфигурируемости под любую хотелку, мы концентрируемся на том, чтобы всё работало как следует сразу из коробки и не напрягало разработчика необходимостью настройки.
...
**Трансляцию современного CSS в CSS поддерживаемый браузерами** ([postcss-cssnext](https://github.com/MoOx/postcss-cssnext)): расстановка префиксов, разворачивание переменных.
