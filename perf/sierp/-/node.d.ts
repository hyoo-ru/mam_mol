...
declare namespace $ {
	...
	type $mol_perf_sierp_dot__left__5SYBI0BJ = $mol_type_enforce<
		ReturnType< $mol_perf_sierp['left'] >
		,
		ReturnType< $mol_perf_sierp_dot['left'] >
	>
	type $mol_perf_sierp_dot__top__KY7I5VB7 = $mol_type_enforce<
		ReturnType< $mol_perf_sierp['top'] >
		,
		ReturnType< $mol_perf_sierp_dot['top'] >
	>
	type $mol_perf_sierp_dot__size__HNUGDTYR = $mol_type_enforce<
		ReturnType< $mol_perf_sierp['size'] >
		,
		ReturnType< $mol_perf_sierp_dot['size'] >
	>
	type $mol_perf_sierp_dot__text__8NND41V4 = $mol_type_enforce<
		ReturnType< $mol_perf_sierp['text'] >
		,
		ReturnType< $mol_perf_sierp_dot['text'] >
	>
	type $mol_view__sub__Q0DE46B6 = $mol_type_enforce<
