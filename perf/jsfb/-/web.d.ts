...
declare namespace $ {
	...
	type $mol_speck__value__F0BNLERP = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__Y9PJ3C9O = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__QBD5F104 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__UQSWCXJG = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__AETWC1DW = $mol_type_enforce<
