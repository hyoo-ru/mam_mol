...
declare namespace $ {
	...
	type $mol_speck__value__PVERKR94 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__AGKDAO8S = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__QR9WHZFF = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__OTCB2R8H = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__JZXKG1N4 = $mol_type_enforce<
