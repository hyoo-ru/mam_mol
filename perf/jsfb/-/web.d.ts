...
declare namespace $ {
	...
	type $mol_speck__value__U1GJR1LG = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__MX845V61 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__WTZNVGYR = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__MMWWRL92 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__ULYLA30V = $mol_type_enforce<
