...
declare namespace $ {
	...
	type $mol_speck__value__T9ZY5JWC = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__1PIJ5A2K = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__G5ORLU0O = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__8JRR4NBQ = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__VZIPJLNE = $mol_type_enforce<
