...
declare namespace $ {
	...
	type $mol_speck__value__SY618NLE = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__66Y0UQV3 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__NFRI7JT2 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__WXBPAR4X = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__WKQECN9Z = $mol_type_enforce<
