...
declare namespace $ {
	...
	type $mol_speck__value__R0BE6IDQ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__KGQAEPKZ = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__72VFMSSM = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__BVAK6HQP = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__VRWJ6KN7 = $mol_type_enforce<
