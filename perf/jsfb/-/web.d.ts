...
declare namespace $ {
	...
	type $mol_speck__value__MHDNEJMM = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__1TDWJWQL = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__YPASM74H = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__G4A2BG0S = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__4J5778V9 = $mol_type_enforce<
