...
declare namespace $ {
	...
	type $mol_speck__value__BZ1J4XJJ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__ZLHNP8O2 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__AS0IY7ZY = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__NCA5OHO0 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__H3S9MGOU = $mol_type_enforce<
