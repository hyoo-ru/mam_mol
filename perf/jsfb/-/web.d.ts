...
declare namespace $ {
	...
	type $mol_speck__value__JJ4KVVO3 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__WZ76XRJY = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__0CEPTC57 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__TMNEZYFD = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__UBYURLO9 = $mol_type_enforce<
