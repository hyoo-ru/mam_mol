...
declare namespace $ {
	...
	type $mol_speck__value__80BRWPO4 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__EL5E2SMQ = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__ILBHC0SS = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__V3QF71T7 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__4XQSPJAA = $mol_type_enforce<
