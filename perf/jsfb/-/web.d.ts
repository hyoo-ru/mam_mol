...
declare namespace $ {
	...
	type $mol_speck__value__QBZJQTWH = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__9TC6T066 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__1ZI4PG2L = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__VRO3GT5Y = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__43T3N8DL = $mol_type_enforce<
