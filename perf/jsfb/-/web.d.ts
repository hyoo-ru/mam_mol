...
declare namespace $ {
	...
	type $mol_speck__value__A5C7T70Z = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__W188GE74 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__QZ5XSMKC = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__942NDKLS = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__DVT1PDQP = $mol_type_enforce<
