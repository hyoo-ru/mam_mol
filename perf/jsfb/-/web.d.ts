...
declare namespace $ {
	...
	type $mol_speck__value__EM26TLU6 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__EQHNOEJK = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__M5HLTRRP = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__MK9OKZU2 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__DNEHKI1P = $mol_type_enforce<
