...
declare namespace $ {
	...
	type $mol_speck__value__ZDJQ4UYQ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__X7NLHVZK = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__GLWM93BB = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__DJGRXSEY = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__QR9B5JAB = $mol_type_enforce<
