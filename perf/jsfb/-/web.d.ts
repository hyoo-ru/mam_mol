...
declare namespace $ {
	...
	type $mol_speck__value__H1XJXB43 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__LCR0SBGL = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__63BMQTYU = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__72RVBLML = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__K16FA9TU = $mol_type_enforce<
