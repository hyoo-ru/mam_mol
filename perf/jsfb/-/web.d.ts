...
declare namespace $ {
	...
	type $mol_speck__value__EJ36M137 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__ZSZEM81Q = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__QU42FB7U = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__AUXG8QOZ = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__5KX8GLIT = $mol_type_enforce<
