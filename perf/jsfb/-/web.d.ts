...
declare namespace $ {
	...
	type $mol_speck__value__K5S39RWJ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__KH7AIJO4 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__K79QSAE2 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__NTVG4D7D = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__3V9Y15HD = $mol_type_enforce<
