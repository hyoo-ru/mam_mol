...
declare namespace $ {
	...
	type $mol_speck__value__GCIFFNF7 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__COR8J1K1 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__WX25SEMR = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__ATV3O87A = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__1KO05Z2U = $mol_type_enforce<
