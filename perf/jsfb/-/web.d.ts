...
declare namespace $ {
	...
	type $mol_speck__value__UWFW247P = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__KTHNTG0U = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__KDDZL7XC = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__QE0IM1VJ = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__224I6HR6 = $mol_type_enforce<
