...
declare namespace $ {
	...
	type $mol_speck__value__Y9MZ6RKW = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__C9D26DR5 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__GJX5MZ04 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__QXI49U3W = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__RPH41SQI = $mol_type_enforce<
