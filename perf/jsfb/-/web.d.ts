...
declare namespace $ {
	...
	type $mol_speck__value__9WZ6ZIOK = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__XW914LHS = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__Y0QDOJGF = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__8DV7OZCI = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__XRGGWWYT = $mol_type_enforce<
