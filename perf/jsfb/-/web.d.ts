...
declare namespace $ {
	...
	type $mol_speck__value__3WI457A2 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__9YI66I53 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__R9E9NNZB = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__JJ7AAV42 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__2NBAZRKO = $mol_type_enforce<
