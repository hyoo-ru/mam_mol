...
declare namespace $ {
	...
	type $mol_speck__value__UIC4C00W = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__S83G457G = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__TLJTAOWP = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__3YIDX0XU = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__YULEBK9Y = $mol_type_enforce<
