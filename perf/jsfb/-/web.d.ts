...
declare namespace $ {
	...
	type $mol_speck__value__E5CB8134 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__D6GMGOHP = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__06DQDE55 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__QBMU5Y46 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__285FWFY0 = $mol_type_enforce<
