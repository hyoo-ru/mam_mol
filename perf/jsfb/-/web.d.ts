...
declare namespace $ {
	...
	type $mol_speck__value__2A9540LD = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__4EI5YRXG = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__HHG1YVTI = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__5D5ZT74C = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__RB28W0GQ = $mol_type_enforce<
