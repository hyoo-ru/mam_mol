...
declare namespace $ {
	...
	type $mol_speck__value__HF7G54FE = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__VN2HAZYK = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__VSCQMN8I = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__46KL4AEQ = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__8DE8IF1L = $mol_type_enforce<
