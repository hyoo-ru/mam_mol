...
declare namespace $ {
	...
	type $mol_speck__value__K6CQK4OV = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__WG15IPKX = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__RURTPVVN = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__V3EEGGB2 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__N4VH6OR6 = $mol_type_enforce<
