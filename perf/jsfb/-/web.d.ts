...
declare namespace $ {
	...
	type $mol_speck__value__U4BVN0XA = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__E31ZIRWO = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__D73M96QV = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__LFHB7ZDO = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__PSLT24LF = $mol_type_enforce<
