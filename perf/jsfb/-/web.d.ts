...
declare namespace $ {
	...
	type $mol_speck__value__6BO3TDTG = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__EMLL4EMR = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__288IXYCK = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__4RGGH84K = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__MG0XGB4J = $mol_type_enforce<
