...
declare namespace $ {
	...
	type $mol_speck__value__QP7XW240 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__QWD2ZW93 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__TC0CKA8X = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__UQSMKQ4M = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__C7C4V3VJ = $mol_type_enforce<
