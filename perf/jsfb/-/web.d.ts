...
declare namespace $ {
	...
	type $mol_speck__value__IAMW4G41 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__RG6VVTIN = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__AFIIWQ0A = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__1MHVT3O3 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__84WY98SB = $mol_type_enforce<
