...
declare namespace $ {
	...
	type $mol_speck__value__FSB5O3DS = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__2M0D3S0W = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__E346O6HW = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__4H5HFYK6 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__JM0C6JRB = $mol_type_enforce<
