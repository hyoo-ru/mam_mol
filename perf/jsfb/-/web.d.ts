...
declare namespace $ {
	...
	type $mol_speck__value__INNA972Y = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__8D7JEYEQ = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__3UV7PQ5G = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__YR1419VB = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__J2M5J24V = $mol_type_enforce<
