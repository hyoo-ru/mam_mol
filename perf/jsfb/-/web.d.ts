...
declare namespace $ {
	...
	type $mol_speck__value__4EWGCC7G = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__O274RLXK = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__BVRZ2HA4 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__R1CT8BPX = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__LTXYG3OW = $mol_type_enforce<
