...
declare namespace $ {
	...
	type $mol_speck__value__6GKD8RNB = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__WPJEPOBT = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__9QJVPNBL = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__QPUCRL2V = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__NL6SRAG9 = $mol_type_enforce<
