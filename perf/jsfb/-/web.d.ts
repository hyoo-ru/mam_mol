...
declare namespace $ {
	...
	type $mol_speck__value__239CRLVT = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__JJPJCZ7V = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__IGCIWGHC = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__LSIV2Q20 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__FTRJIV4Q = $mol_type_enforce<
