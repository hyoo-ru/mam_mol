...
declare namespace $ {
	...
	type $mol_speck__value__9GQSWI6Y = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__UTPOTGAF = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__0Z4LO5WE = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__ZF8E2O6B = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__07J203WZ = $mol_type_enforce<
