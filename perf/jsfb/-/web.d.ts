...
declare namespace $ {
	...
	type $mol_speck__value__3ZJE19YM = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__AN85F11N = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__99ZL0MUE = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__0V55QDO7 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__52JJ3STB = $mol_type_enforce<
