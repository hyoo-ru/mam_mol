...
declare namespace $ {
	...
	type $mol_speck__value__3MXMPXPQ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__G77XKLUX = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__6IXI9B1C = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__LPYCCYGL = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__VYBKIX3T = $mol_type_enforce<
