...
declare namespace $ {
	...
	type $mol_speck__value__86ZRQHMF = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__C9UCCC1K = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__47WS53WE = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__3U7PP1SC = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__K29KGRKG = $mol_type_enforce<
