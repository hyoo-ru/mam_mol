...
declare namespace $ {
	...
	type $mol_speck__value__8A7GQSIU = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__ZPS0HWA0 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__09S8NOB5 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__2BS9NMAK = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__5PB45FK3 = $mol_type_enforce<
