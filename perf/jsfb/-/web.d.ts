...
declare namespace $ {
	...
	type $mol_speck__value__TF1MOHOV = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__0D0POEVV = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__HE36I33Q = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__6WCVHK7M = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__R9GNJGSI = $mol_type_enforce<
