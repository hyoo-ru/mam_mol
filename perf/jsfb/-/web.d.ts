...
declare namespace $ {
	...
	type $mol_speck__value__LOXEE011 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__SUL4H8KN = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__2SPV2R5I = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__SDD76FH6 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__1ZO5BU82 = $mol_type_enforce<
