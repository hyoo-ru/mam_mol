...
declare namespace $ {
	...
	type $mol_speck__value__CW3EEGY4 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__CAWG4IHR = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__5UEARTHX = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__HJENQWY1 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__XZ6IABL4 = $mol_type_enforce<
