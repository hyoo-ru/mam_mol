...
declare namespace $ {
	...
	type $mol_speck__value__4LAVCRH8 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__2B0WT7BQ = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__29W4QAKD = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__QPA3VNXI = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__5U5KOXQ0 = $mol_type_enforce<
