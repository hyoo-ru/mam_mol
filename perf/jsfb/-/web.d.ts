...
declare namespace $ {
	...
	type $mol_speck__value__AC1GVAEA = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__ECQNVJ9F = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__PTS3T0VB = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__Q3VPBXQB = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__687GCU66 = $mol_type_enforce<
