...
declare namespace $ {
	...
	type $mol_speck__value__J62JF7YZ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__435XXM20 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__721395BL = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__IF0YI0SR = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__RXDJOGMX = $mol_type_enforce<
