...
declare namespace $ {
	...
	type $mol_speck__value__D5OIMOHT = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__SMTM7JW5 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__0CL6X0OM = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__V6MBS4WC = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__JYEWL9B5 = $mol_type_enforce<
