...
declare namespace $ {
	...
	type $mol_speck__value__N6OC6V2E = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__017ANPRR = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__4F3XPYNQ = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__XV0I9635 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__M4EUFF6Z = $mol_type_enforce<
