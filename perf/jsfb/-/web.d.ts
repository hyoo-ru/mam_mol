...
declare namespace $ {
	...
	type $mol_speck__value__KQPS697H = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__6HA40W23 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__405BTX38 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__GWDUCMU5 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__LW1SPQLE = $mol_type_enforce<
