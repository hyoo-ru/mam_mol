...
declare namespace $ {
	...
	type $mol_speck__value__4RDB3AXO = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__UQIG7IJP = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__VBNTD4GQ = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__7D0DESNW = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__PU9PH2R8 = $mol_type_enforce<
