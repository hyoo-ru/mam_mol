...
declare namespace $ {
	...
	type $mol_speck__value__9BBIX8XR = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__58UNZG3Q = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__244CCKPU = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__BH2DOQMH = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__KC94PTAS = $mol_type_enforce<
