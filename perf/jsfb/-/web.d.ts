...
declare namespace $ {
	...
	type $mol_speck__value__WN5AO8OP = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__DY11F8VF = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__FLZ61AAN = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__3QEOA9JQ = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__BIG7N4AM = $mol_type_enforce<
