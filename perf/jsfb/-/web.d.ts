...
declare namespace $ {
	...
	type $mol_speck__value__WW1IXO20 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__85ZNWCPG = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__1CVE7HXG = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__PNEVA7J6 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__UJB4KKWS = $mol_type_enforce<
