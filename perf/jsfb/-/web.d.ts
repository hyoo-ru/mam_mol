...
declare namespace $ {
	...
	type $mol_speck__value__VHBZJ3E0 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__JET7ANK1 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__963WY1KQ = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__PMX35KYS = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__8X4SYS7Q = $mol_type_enforce<
