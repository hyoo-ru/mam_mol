...
declare namespace $ {
	...
	type $mol_speck__value__I3KG1331 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__FW5BV66L = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__ZLNLFWTD = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__8XL47NJE = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__KRUDLVV4 = $mol_type_enforce<
