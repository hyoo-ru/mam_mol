...
declare namespace $ {
	...
	type $mol_speck__value__13XQ3OQE = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__GYI2C7D5 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__03BACCZM = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__ESBDBBLV = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__EAD8H3XR = $mol_type_enforce<
