...
declare namespace $ {
	...
	type $mol_speck__value__5BRSNR42 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__FOONMZYO = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__DCQTC1J0 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__RPCAU0G7 = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__W4TT2FZG = $mol_type_enforce<
