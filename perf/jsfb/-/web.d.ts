...
declare namespace $ {
	...
	type $mol_speck__value__W86Z9LFX = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__4HDRL32M = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__9B8W6NAG = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__8AXHFNQD = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__Y0KQWKP2 = $mol_type_enforce<
