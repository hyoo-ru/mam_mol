...
declare namespace $ {
	...
	type $mol_speck__value__0R9VXB41 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__style__QBG16380 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__32T5B2SQ = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__sub__WF6LYMMT = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__KXOSDA1P = $mol_type_enforce<
