...
declare namespace $ {
	...
	type $mol_view__style__0XYLXAZW = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__NX1BICZT = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_pop_bubble__align__GGRMMV4E = $mol_type_enforce<
		ReturnType< $mol_pop['align'] >
		,
		ReturnType< $mol_pop_bubble['align'] >
	>
	type $mol_pop_bubble__content__94NXQRXW = $mol_type_enforce<
		ReturnType< $mol_pop['bubble_content'] >
		,
		ReturnType< $mol_pop_bubble['content'] >
	>
	type $mol_pop_bubble__height_max__23EFGMCE = $mol_type_enforce<
