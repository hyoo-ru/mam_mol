...
declare namespace $ {
	...
	type $mol_view__style__CC6K3M6G = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__BI57B2V5 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_pop_bubble__align__J2Q7PM3T = $mol_type_enforce<
		ReturnType< $mol_pop['align'] >
		,
		ReturnType< $mol_pop_bubble['align'] >
	>
	type $mol_pop_bubble__content__RWWBI07R = $mol_type_enforce<
		ReturnType< $mol_pop['bubble_content'] >
		,
		ReturnType< $mol_pop_bubble['content'] >
	>
	type $mol_pop_bubble__height_max__F9TP4OLQ = $mol_type_enforce<
