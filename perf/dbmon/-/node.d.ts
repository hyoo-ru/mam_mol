...
declare namespace $ {
	...
	type $mol_view__style__1WOI0QDY = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__QSI1Q9ZS = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_pop_bubble__align__XPR1G3B4 = $mol_type_enforce<
		ReturnType< $mol_pop['align'] >
		,
		ReturnType< $mol_pop_bubble['align'] >
	>
	type $mol_pop_bubble__content__2V7UXISD = $mol_type_enforce<
		ReturnType< $mol_pop['bubble_content'] >
		,
		ReturnType< $mol_pop_bubble['content'] >
	>
	type $mol_pop_bubble__height_max__L0NO446H = $mol_type_enforce<
