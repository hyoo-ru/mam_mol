...
declare namespace $ {
	...
	type $mol_view__style__RUCB58PU = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__JJCUSM4M = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_pop_bubble__align__O4RE9RGH = $mol_type_enforce<
		ReturnType< $mol_pop['align'] >
		,
		ReturnType< $mol_pop_bubble['align'] >
	>
	type $mol_pop_bubble__content__HBT8IIPW = $mol_type_enforce<
		ReturnType< $mol_pop['bubble_content'] >
		,
		ReturnType< $mol_pop_bubble['content'] >
	>
	type $mol_pop_bubble__height_max__S6JZTNNU = $mol_type_enforce<
