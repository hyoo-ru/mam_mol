...
(function ($) {
    let $mol_perf_uibench_table_row = (() => {
...
(function ($) {
    let $mol_perf_uibench_table_cell = (() => {
...
(function ($) {
    let $mol_perf_uibench_tree_branch = (() => {
