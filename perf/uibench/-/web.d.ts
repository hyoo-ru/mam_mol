...
declare namespace $ {
	...
	type $mol_view__style__RYDM5YEG = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__UVQDBAB6 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__0ONSXNCB = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__3OSEPADQ = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['cell_state'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__AV3YD0S5 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__S7DCD2LC = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__CLOUFHC3 = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__FBX3JWX0 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__KQ4GK7Z5 = $mol_type_enforce<
