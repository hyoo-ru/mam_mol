...
declare namespace $ {
	...
	type $mol_view__style__KLCNATK3 = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__ALVJW4WL = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__WZHBXE64 = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__108MAB5B = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['head_text'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__OH8WSPFH = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__T6SQED90 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__NTKRZAQ0 = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__CBM2HAGS = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__1EKZJ53E = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__6Y56UB9V = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__CD1ZJD4K = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__HXTTG0VE = $mol_type_enforce<
