...
declare namespace $ {
	...
	type $mol_view__style__3TJLN6XV = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__AEZAWQRQ = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__JZU5E4CD = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__AYFGKMVS = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['head_text'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__N21FRNG4 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__W0RX6MWF = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__F2B7V4B0 = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__UZG2CG8T = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__N5OT1J52 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__B9P99QE9 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__QXLKVW3R = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__V0J83XVK = $mol_type_enforce<
