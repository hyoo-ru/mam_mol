...
declare namespace $ {
	...
	type $mol_view__style__M0IK4LHX = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__HVA289II = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__1IYD81DI = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__PVCV5HA4 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['head_text'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__9WKXTL4M = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__PIV4EBAW = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__Z5Z2CJ4E = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__SSKAVLAS = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__2RH71DZZ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__TRCOT20G = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__0DR0F3UJ = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__FTZK3D2G = $mol_type_enforce<
