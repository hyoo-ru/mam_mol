...
declare namespace $ {
	...
	type $mol_view__style__CSMKM5W2 = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__86DRVHTL = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__MHAFQ8BE = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__ETCZ1E8O = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['cell_state'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__POC5DP09 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__G0VT26CC = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__NMZZPI7Z = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__VXK0S9AR = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__LPASM0U2 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__DSNZWSFN = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__OZIPGZGL = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__ZC8BOSCX = $mol_type_enforce<
