...
declare namespace $ {
	...
	type $mol_view__style__UZTKX9TB = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__NNJ48735 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__WI9FZKX7 = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__A83KGZHA = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['head_text'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__XH122RO7 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__OOE1R8CG = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__9PUIFMD6 = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__YEBAI369 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__381WROFV = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__XS6HSA8C = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__O9G15L9X = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__MUGFEN8G = $mol_type_enforce<
