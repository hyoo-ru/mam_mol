...
declare namespace $ {
	...
	type $mol_view__style__UQRXIZ07 = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__0KJ6NG7P = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__602SAOCM = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__ON2F1VQQ = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['head_text'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__XLGG6J6U = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__KRZ16Z9N = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__NM5HQA04 = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__6B9TMP4O = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__5BB46EOR = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__ARS4LMOI = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__XIO39AZO = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__IODENLNX = $mol_type_enforce<
