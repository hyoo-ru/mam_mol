...
declare namespace $ {
	...
	type $mol_view__style__9RIIFCSU = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__BUSURA2L = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__5IP4BFK3 = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__6FUEVFJ1 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['head_text'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__DT00YMRD = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__214KBDHQ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__5X011BW3 = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__AYEISJUD = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__URMVER5T = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__95PRL6VV = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__NQ5R7AEP = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__XQW9NIVX = $mol_type_enforce<
