...
declare namespace $ {
	...
	type $mol_view__style__7QZ8Z171 = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__JB98VPM8 = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__OS6GL2QX = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__E3DNYJ8B = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['head_text'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__QB0RZ3R1 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__MFRKRE4I = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__NXTJW8SF = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__3T75DT2P = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__28C6DQYQ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__M3GBBY13 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__MM0Z8W77 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__D9WOUL12 = $mol_type_enforce<
