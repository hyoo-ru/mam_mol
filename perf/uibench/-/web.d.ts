...
declare namespace $ {
	...
	type $mol_view__style__ZKIICUWE = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__TH95L30B = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__BYSLQZ59 = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__QWBTXLRC = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['head_text'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__PFV47VR6 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__BGAUYX65 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__FEX84R36 = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__M66D8RZD = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__3G6QWRGV = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__TQIHV4GT = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__Z36KMHO1 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__L1PG401T = $mol_type_enforce<
