...
declare namespace $ {
	...
	type $mol_view__style__LXQSG6QP = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__T61XBH9C = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__QWP1A2YN = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__N2E87J49 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['cell_state'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__GJ1JVLWC = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__TALKFVRS = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__ONQZSBVB = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__8VBFELGJ = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__2T9WXUW2 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__Q8GWF8GI = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__U01PEKQ6 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__WJ1H90VP = $mol_type_enforce<
