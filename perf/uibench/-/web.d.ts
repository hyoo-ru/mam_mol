...
declare namespace $ {
	...
	type $mol_view__style__1NGX9G7P = $mol_type_enforce<
		({ 
	...
	>
	type $mol_view__style__HNHPJE0E = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_perf_uibench_table_row__state__5HCJ0HOD = $mol_type_enforce<
	...
	type $mol_perf_uibench_table_cell__text__SK485M10 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_table_row['head_text'] >
		,
		ReturnType< $mol_perf_uibench_table_cell['text'] >
	>
	type $mol_perf_uibench_table_cell__text__EX8AE2LQ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_anim_box__state__Y9PVV6Y2 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_tree_branch__state__KMFK98O7 = $mol_type_enforce<
	...
	type $mol_perf_uibench_tree_branch__state__DVFH17KP = $mol_type_enforce<
		ReturnType< $mol_perf_uibench_tree_branch['branch_state'] >
		,
		ReturnType< $mol_perf_uibench_tree_branch['state'] >
	>
	type $mol_perf_uibench_tree_leaf__text__00C12QI7 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_perf_uibench_table__state__T95L70E5 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['table_state'] >
		,
		ReturnType< $mol_perf_uibench_table['state'] >
	>
	type $mol_perf_uibench_anim__state__TD4JAGZ0 = $mol_type_enforce<
		ReturnType< $mol_perf_uibench['anim_state'] >
		,
		ReturnType< $mol_perf_uibench_anim['state'] >
	>
	type $mol_perf_uibench_tree__state__B2QPWWBB = $mol_type_enforce<
