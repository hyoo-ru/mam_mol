...
(function ($) {
    ...
    __decorate([
        $.$mol_mem
    ], $mol_app_studio_field.prototype, "Label", null);
    __decorate([
        $.$mol_mem
    ...
    __decorate([
        $.$mol_mem
    ], $mol_app_studio_field.prototype, "Value", null);
    __decorate([
        $.$mol_mem
        ...
        class $mol_app_studio_field extends $.$mol_app_studio_field {
            ...
            type(next) {
                if (next) {
                    ...
                    switch (next) {
                        case 'null':
                            val = $.$mol_tree2.struct('null');
                            break;
                        case 'bool':
                            val = $.$mol_tree2.struct('false');
                            break;
                        case 'number':
                            val = $.$mol_tree2.struct('NaN');
                            break;
                        case 'string':
                            val = $.$mol_tree2.data('');
                            break;
                        case 'locale':
                            val = $.$mol_tree2.struct('@', [$.$mol_tree2.struct('')]);
                            break;
                        case 'get':
                            val = $.$mol_tree2.struct('<=', [$.$mol_tree2.struct('?')]);
                            break;
                        case 'bind':
                            ...
                            break;
                        case 'list':
                            val = $.$mol_tree2.struct('/');
                            break;
                        case 'dict':
                            val = $.$mol_tree2.struct('*');
                            break;
                        case 'object':
                            val = $.$mol_tree2.struct('$mol_view');
                            break;
            ...
            class(next) {
                return this.value(next && $.$mol_tree2.struct(next) || undefined).type;
            }
            bind(next) {
                return this.value(next && this.value().clone([$.$mol_tree2.struct(next)]) || undefined).kids[0].type;
            }
            value_bool(next) {
