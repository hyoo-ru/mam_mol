...
(function ($) {
    class $mol_app_todomvc extends $.$mol_scroll {
        ...
        foot_content() {
            return [this.Pending(), this.Filter(), this.Sweep()];
        }
        Pending() {
            return ((obj) => {
                obj.sub = () => [this.pending_message()];
                return obj;
            })(new this.$.$mol_view());
        }
        pending_message() {
        ...
        filterOptions() {
            return [this.Filter_all(), this.Filter_active(), this.Filter_completed()];
        }
        Filter_all() {
            return ((obj) => {
                obj.sub = () => [this.filter_all_label()];
                obj.arg = () => ({
                    "completed": null,
                });
                return obj;
        ...
        Filter_active() {
            return ((obj) => {
                obj.sub = () => [this.filter_active_label()];
                obj.arg = () => ({
                    "completed": "false",
                });
                return obj;
        ...
        Filter_completed() {
            return ((obj) => {
                obj.sub = () => [this.filter_completed_label()];
                obj.arg = () => ({
                    "completed": "true",
                });
                return obj;
...
(function ($) {
    class $mol_app_todomvc_task_row extends $.$mol_view {
        ...
        sub() {
            return [this.Complete(), this.Title(), this.Drop()];
        }
        Complete() {
            return ((obj) => {
    ...
    (function ($$) {
        ...
        class $mol_app_todomvc extends $.$mol_app_todomvc {
            ...
            task_completed(id, next) {
                return this.task(id, next === undefined ? undefined : Object.assign(Object.assign({}, this.task(id)), { completed: next })).completed;
            }
            task_title(id, next) {
