...
(function ($) {
    class $mol_app_issues extends $.$mol_page {
        ...
        body() {
            return [this.Projects(), this.Chart(), this.Description()];
        }
        Projects() {
            return ((obj) => {
        ...
        Chart() {
            return ((obj) => {
                obj.gap_left = () => 76;
                obj.graphs = () => [this.Capacities(), this.Capacities_ruler(), this.Capacities_ruler_hor()];
                return obj;
...
(function ($) {
    class $mol_app_issues_project extends $.$mol_view {
        ...
        sub() {
            return [this.Input(), this.Capacity()];
        }
        Input() {
            return ((obj) => {
                obj.sub = () => [this.Id(), this.Homepage()];
                return obj;
            })(new this.$.$mol_view());
        }
        Id() {
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $.$mol_mem
        ], $mol_app_issues.prototype, "project_labels", null);
        $$.$mol_app_issues = $mol_app_issues;
        class $mol_app_issues_project extends $.$mol_app_issues_project {
            ...
            project() {
                return this.$.$mol_fetch.json(this.uri_project());
            }
            homepage() {
                if (!this.id())
                    return 'about:blank';
            ...
            issues_page(page) {
                return this.$.$mol_fetch.json(this.uri_issues() + '&page=' + page);
            }
            issues() {
