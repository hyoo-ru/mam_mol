        ...
        class $mol_app_questions extends $.$mol_book {
            ...
            Question_link(index) {
                return ((obj) => {
                    ...
                    obj.sub = () => [this.Question_title(index), this.Question_tags(index)];
                    return obj;
                })(new this.$.$mol_link());
            }
            ...
            Question_title(index) {
                return ((obj) => {
                    obj.sub = () => [this.question_title_by_index(index)];
                    return obj;
                })(new this.$.$mol_view());
            }
