...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $.$mol_mem
        ], $mol_app_life_map.prototype, "cycle", null);
        __decorate([
            $.$mol_fiber_solid.method
        ], $mol_app_life_map.prototype, "step", null);
        __decorate([
            $.$mol_mem
...
var $;
(function ($) {
    $.$mol_style_attach("mol/app/life/map/map.view.css", "[mol_app_life_map] {\n\tposition: relative;\n}\n");
})($ || ($ = {}));
//map.view.css.js.map
;
"use strict";
