    ...
    class $mol_app_bench_chart_rope_mol extends $.$mol_view {
        ...
        Graph(id) {
            return ((obj) => {
                ...
                obj.graphs = () => [this.Line(id), this.Dots(id)];
                return obj;
...
(function ($) {
    ...
    (function ($$) {
        class $mol_app_bench_chart_rope_mol extends $.$mol_app_bench_chart_rope_mol {
            ...
            series(id) {
                var _a;
                return (_a = $mol_app_bench_chart_rope_mol.data().graphs[id]) !== null && _a !== void 0 ? _a : [];
            }
        }
        __decorate([
            $.$mol_mem
...
var $;
(function ($) {
    $.$mol_style_attach("mol/app/bench/chart/rope/mol/mol.view.css", "[mol_app_bench_chart_rope_mol] {\n\tdisplay: flex;\n}\n");
})($ || ($ = {}));
//mol.view.css.js.map
;
"use strict";
